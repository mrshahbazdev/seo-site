                ...
                <div style={{ maxWidth: '860px', margin: '0 auto', padding: '0 24px' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                        <div>
                            ...
                            <h1 style={{ fontSize: '24px', fontWeight: '800', color: '#0f172a', margin: 0 }}>{t('settings.agencySettings')}</h1>
                            <p style={{ color: '#64748b', margin: '4px 0 0' }}>{t('settings.customizeBranding')}</p>
                        </div>
                        <LanguageSwitcher />
                    </div>
                </div>
            ...
            <div style={{ maxWidth: '860px', margin: '32px auto', padding: '0 24px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
                ...
                <form onSubmit={handleSave}>
                    <div style={{ background: 'white', borderRadius: '16px', border: '1px solid #e2e8f0', overflow: 'hidden' }}>
                        <div style={{ padding: '24px', borderBottom: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', gap: '12px' }}>
                            ...
                            <div>
                                <h2 style={{ margin: 0, fontSize: '16px', fontWeight: '700', color: '#0f172a' }}>{t('settings.agencyBranding')}</h2>
                                <p style={{ margin: '2px 0 0', fontSize: '13px', color: '#64748b' }}>{t('settings.brandingDesc')}</p>
                            </div>
                        </div>
                        <div style={{ padding: '28px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            ...
                            <div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                                    ...
                                    <div>
                                        ...
                                        <p style={{ margin: '4px 0 0', fontSize: '12px', color: '#94a3b8' }}>{t('settings.logoHint')}</p>
                                    </div>
                                </div>
                            ...
                            {/* Company Name */}
                            <div>
                                <label style={{ display: 'block', fontSize: '13px', fontWeight: '600', color: '#374151', marginBottom: '6px' }}>{t('settings.companyName')}</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                    ...
                                    />
                                    <span style={{ fontSize: '13px', color: '#94a3b8' }}>{t('settings.colorUsage')}</span>
                                </div>
                            </div>

                            {/* Report Footer */}
                            <div>
                                <label style={{ display: 'block', fontSize: '13px', fontWeight: '600', color: '#374151', marginBottom: '6px' }}>{t('settings.reportFooter')}</label>
                                <input
                                    type="text"
                                    value={settings.report_footer}
                                    onChange={e => setSettings(s => ({ ...s, report_footer: e.target.value }))}
                                    placeholder={t('settings.reportFooterPlaceholder')}
                                    style={{ width: '100%', padding: '10px 14px', border: '1px solid #e2e8f0', borderRadius: '8px', fontSize: '14px', outline: 'none', boxSizing: 'border-box' }}
                                />
                            </div>
                ...
                <div style={{ background: 'white', borderRadius: '16px', border: '1px solid #e2e8f0', overflow: 'hidden' }}>
                    <div style={{ padding: '24px', borderBottom: '1px solid #f1f5f9', display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        <div>
                            <h2 style={{ margin: 0, fontSize: '16px', fontWeight: '700', color: '#0f172a' }}>{t('settings.googleSearchConsole')}</h2>
                            <p style={{ margin: '2px 0 0', fontSize: '13px', color: '#64748b' }}>{t('settings.googleDesc')}</p>
                        </div>
                    </div>
                        ...
                        {googleEmail ? (
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px', background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: '12px' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                    ...
                                    <div>
                                        <div style={{ fontWeight: '700', color: '#15803d', fontSize: '14px' }}>{t('settings.connected')}</div>
                            ...
                            <div>
                                ...
                                >
                                    <Link2 size={16} /> {t('settings.connectGoogleAccount')}
                                </button>
                                <p style={{ margin: '10px 0 0', fontSize: '12px', color: '#94a3b8' }}>
                                    {t('settings.googleCloudNote')} <a href="https://console.cloud.google.com/" target="_blank" rel="noreferrer" style={{ color: '#2563eb' }}>{t('settings.openCloudConsole')} <ExternalLink size={10} style={{display:'inline'}}/></a>
                                </p>
                            </div>
                        )}
                    </div>
